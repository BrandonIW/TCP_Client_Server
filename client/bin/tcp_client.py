...
def _build_logger():
    ...
    file_handler_info = RotatingFileHandler('../logs/TCPClient_info.log', maxBytes=1048576)
    file_handler_warning = RotatingFileHandler('../logs/TCPClient_warning.log', maxBytes=1048576)
    file_handler_error = RotatingFileHandler('../logs/TCPClient_error.log', maxBytes=1048576)
